...
let btnVagas = ".MuiList-root > a:nth-child(1) > li:nth-child(1)";
let btnAlunos = ".MuiList-root > a:nth-child(2) > li:nth-child(1)";
let btnUsuarios = ".MuiList-root > a:nth-child(3) > li:nth-child(1)";
let btnClientes = ".MuiList-root > a:nth-child(4) > li:nth-child(1)";
